...
<%
	...
	if(searchName == null || searchName.equals("")){
		...
		cntSql = "SELECT COUNT(*) cnt FROM salaries s INNER JOIN employee e ON s.emp_no = e.emp_no WHERE e.first_name LIKE ? OR e.last_name LIKE ?";
		cntStmt = conn.prepareStatement(cntSql);
	...
	if(searchName == null){
		sql = "SELECT s.emp_no empNo, s.salary salary, s.from_date toDate, e.first_name firstName, e.last_name lastName FROM salaries s INNER JOIN employees e ON s.emp_no = e.emp_no ORDER BY s.emp_no ASC LIMIT ?,?";
